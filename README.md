...
The server also sets the MongoDB driver `appName` with the server version and tool name, for example `documentdb-mcp-server/0.1.0 tool/find_documents`, so backend diagnostics can attribute requests to this MCP server and individual tools.
