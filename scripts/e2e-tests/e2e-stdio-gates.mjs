...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"],"allowedDatabases":["fleet"]}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"],"allowedDatabases":["fleet"],"allowedCollections":{"fleet":["vehicles"]}}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"],"allowedDatabases":[]}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"],"allowedDatabases":["fleet"],"allowedCollections":{"fleet":[]}}}' },
    { name: 'find_documents', arguments: { connection_profile: 'dev', db_name: 'fleet', collection_name: 'vehicles', query: {} } },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake"}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":[]}}' },
    { name: 'find_documents', arguments: { connection_profile: 'dev', db_name: 'fleet', collection_name: 'vehicles', query: {} } },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write"]}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"],"allowedDatabases":["fleet","secrets"],"deniedDatabases":["secrets"]}}' },
    { name: 'find_documents', arguments: { connection_profile: 'dev', db_name: 'secrets', collection_name: 'x', query: {} } },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"],"allowedCollections":{"fleet":["vehicles","audit_log"]},"deniedCollections":{"fleet":["audit_log"]}}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"],"deniedCollections":{"fleet":["audit_log"]}}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"]}}' },
...
await check(
    ...
    { ...baseEnv, CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read"]}}' },
...
await check(
    ...
    { ...baseEnv, ENABLE_WRITE_TOOLS: 'false', CONNECTION_PROFILES: '{"dev":{"authMode":"connectionString","uri":"mongodb://fake","allowedRoles":["read","write","management"]}}' },
    { name: 'insert_documents', arguments: { connection_profile: 'dev', db_name: 'fleet', collection_name: 'vehicles', documents: [{ x: 1 }] } },
